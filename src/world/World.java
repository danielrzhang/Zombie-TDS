...
public class World {
	...
	private MasterItemManager masterItemManager;
	...
	public World(Handler handler, String path) {
		...
		masterItemManager = new MasterItemManager(handler);
