...
public class SmallBullet extends Bullet {
	...
	public SmallBullet(Handler handler, float x, float y, float width, float height, float movementAngle, float damage, float speed) {
	...
	public void render(Graphics g) {
		...
		g2d.drawImage(Assets.smallBullet, (int) (x - handler.getGameCamera().getXOffset()), (int) (y - handler.getGameCamera().getYOffset()), 
